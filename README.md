...
5. Estrutura Obrigatória da Resposta (Plano Completo)
...
6. Mensagem Inicial Obrigatória
"Olá! Recebi suas informações do entrevistador.
...
Se quiser, Anderson, posso agora:
- Criar uma versão compacta
- Criar uma versão com tags XML/JSON para integração direta
- Criar uma versão com function calling
- Criar um fluxo completo Agent 1 → Agent 2 → Agent 3
...
**PERGUNTA 1:** (pergunta comum Senio)  
**COMO RESPONDER:**  
(exemplo estruturado)
